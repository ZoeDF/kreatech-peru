...
if(isset($_POST["first_name"]))  {
    ...
    echo ($send_email) ? '<div class="success">Email has been sent successfully.</div>' : 'Error: El e-mail no ha sido enviado.';
} else {
	echo '<div class="failed">Falló el envío del e-mail</div>';
}
?>